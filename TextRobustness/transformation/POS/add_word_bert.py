...
from TextRobustness.transformation.POS import AddWordWordNet
...
class AddWordBERT(AddWordWordNet):
    ...
    def sample_words(self, tokens, index, candidates, n):
        ...
        _tokens.insert(index, self.tokenizer.mask_token)
...
if __name__ == "__main__":
    ...
    add_ins = AddWordBERT(treebank_tags=['NN'], add_treebank_tags=['JJ'])
